...
export default function LoginPage() {
  return (
    <div className="fixed inset-0 bg-[#0a0c14] flex items-center justify-center z-[100]">
      ...
      <div className="relative w-full max-w-md p-8">
        <div className="glass-card p-10 flex flex-col items-center text-center">
          <div className="w-16 h-16 bg-indigo-600 rounded-2xl flex items-center justify-center mb-8 shadow-2xl shadow-indigo-500/40 animate-bounce-slow">
            <Package className="text-white w-8 h-8" />
          </div>
          
          <h1 className="text-3xl font-bold mb-2">
            JannikJBI <span className="text-slate-500 font-medium">Todo</span>
          </h1>
          <p className="text-slate-400 mb-10 leading-relaxed">
            Asset Management für dein Projekt.<br/>
          ...
          <div className="mt-8 pt-8 border-t border-[#1e2235] w-full">
